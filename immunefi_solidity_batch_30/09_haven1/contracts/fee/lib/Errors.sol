...
/**
 * @dev Raised when an invalid Association share was supplied.
 */
error FeeContract__InvalidAssociationShare();
...
/**
 * @dev Raised when an action required a contract but an EOA (or address with
 * zero code size) was provided.
 *
 * @param addr The address that was provided.
 */
error FeeContract__OnlyContract(address addr);
