...
interface IFeeContract {
    ...
    /**
     * @notice Emitted when an addresses status as a "grace contract" is set.
     *
     * @param addr      The address that was set.
     * @param status    The status that was set.
     */
    event GraceContractSet(address indexed addr, bool status);
     ...
     */
    event FeeUSDSet(uint256 fee);

    /**
     * @notice Emitted when a new Association share is set.
     *
     * @param share The new share value.
     */
    event AssociationShareSet(uint256 share);
     ...
     *
     * @dev Emits a `GraceContractSet` event.
     */
     ...
     *
     * Emits an `AssociationShareSet` event.
     */
