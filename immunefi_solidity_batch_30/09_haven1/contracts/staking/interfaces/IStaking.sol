 ...
 *
 * @dev The interface for the Staking contract.
 */
interface IStaking {
    /**
     ...
     * @param amountToken   The amount of tokens that were staked.
     * @param amountH1      The amount of H1 that was staked.
     */
    event Staked(address indexed user, uint256 amountToken, uint256 amountH1);

    /**
     * @dev Emitted when a user withdraws from the contract.
     *
     * @param user          The address of the user who has withdrawn.
     * @param amountToken   The amount of tokens that were withdrawn.
     * @param amountH1      The amount of H1 that was withdrawn.
     */
    event Withdrawn(
     ...
     * @param rewardAmount  The amount of rewards sent.
     */
     ...
     *
     * @param duration The new rewward duration.
     */
    event RewardDurationUpdated(uint256 duration);

    /**
     * @dev Emitted when the reward amount has been notified.
     *
     ...
     *
     * Emits a `RewardDurationUpdated` event.
     */
     ...
     *
     * @param amountToken_ The amount of tokens to be staked.
     *
     * @dev Requirements:
     * -    The contract must not be paused.
     * -    Either the `amountToken_` or the `msg.value` must be greater than zero.
     * -    The sender must have approved the contract to spend the `_stakingToken`
     *      for at least `amountToken_`.

     * Emits a `Staked` event.
     */
    function stake(uint256 amountToken_) external payable;

    /**
     * @notice Allows a user to withdraw their staked tokens and / or H1.
     *
     * @param amountToken_  The amount of staking tokens to withdraw.
     * @param amountH1_     The amount of native H1 to withdraw.
     *
     * @dev Requirements:
     * -    The contract must not be paused.
     * -    Either the `amountToken_` or the `amountH1_` must be greater than zero.
     * -    A Native Application fee must be sent in.
     *
     * Emits a `Withdrawn` event.
     */
    function withdraw(uint256 amountToken_, uint256 amountH1_) external payable;
    ...
    /**
     * @notice Returns the amount of H1 an `account` has deposited in the
     * contract.
     *
     * @param account The address of the account to check.
     *
     * @return The amount of H1 an `account` has deposited in the contract.
     */
