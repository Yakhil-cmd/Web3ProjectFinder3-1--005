    ...
    INetworkGuardian
{
    ...
    /**
     * @notice Hook that executes before `NetworkGuardian::setAssociation()`
     * is called.
     *
     * @param addr The new Association address.
     *
     * @dev Inheriting contracts may define additional roles and assign them to
     * the Association. This function allows those contracts to implement
     * additional logic when the Association address changes, ensuring a smooth
     * and complete handover.
     *
     * Inheriting contracts should override this function if they require custom
     * pre-processing before an Association change.
     */
    function _beforeSetAssociation(address addr) internal virtual {}
