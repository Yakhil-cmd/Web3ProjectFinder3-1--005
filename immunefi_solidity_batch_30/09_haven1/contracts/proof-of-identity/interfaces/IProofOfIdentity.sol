...
interface IProofOfIdentity {
    ...
    /**
     * @notice Emitted when an attribute's name was updated.
     *
     * @param id    The ID of the attribute.
     * @param name  The attribute's name.
     */
    event AttributeNameUpdated(uint256 indexed id, string name);

    /**
     * @notice Emitted when an attribute's type was updated.
     *
     * @param id    The ID of the attribute.
     * @param kind  The attribute's type.
     */
    event AttributeTypeUpdated(uint256 indexed id, SupportedAttributeType kind);
     ...
     */
    function setMaxAux(uint256 max) external;
     ...
     *
     * Emits an `AttributeNameUpdated` event.
     */
     ...
     * -    The caller must have the role: `DEFAULT_ADMIN_ROLE`.
     *
     * Emits an `AttributeTypeUpdated` event.
     */
