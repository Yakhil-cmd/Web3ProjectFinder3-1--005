...
contract troveNFTTest is DevTestSetup {
    ...
    function setUp() public override {
        ...
        troveManagerParamsArray[0] = TestDeployer.TroveManagerParams(150e16, 120e16, 120e16, 5e16, 10e16, 10_000_000 ether);
    ...
    function testTroveNFTMetadata() public view {
        assertEq(troveNFTWETH.name(), "Felix Trove - Wrapped Hype Tester", "Invalid Trove Name");
        assertEq(troveNFTWETH.symbol(), "FLX-WHYPE", "Invalid Trove Symbol");

        assertEq(troveNFTWstETH.name(), "Felix Trove - Wrapped Staked Ether", "Invalid Trove Name");
        assertEq(troveNFTWstETH.symbol(), "FLX-wstETH", "Invalid Trove Symbol");

        assertEq(troveNFTRETH.name(), "Felix Trove - Rocket Pool ETH", "Invalid Trove Name");
        assertEq(troveNFTRETH.symbol(), "FLX-rETH", "Invalid Trove Symbol");
    }
    ...
    function testTroveURI() public {
        ...
        deal(address(feUSDToken), A, 30000e18);
        redeem(A, 30000e18);
    ...
    function testTroveURIAttributes() public view {
        ...
        assertTrue(
            LibString.contains(decodedUri, string.concat('"value": "', Strings.toHexString(address(feUSDToken)))),
