...
contract InterestRateAggregate is DevTestSetup {
    ...
    function testCalcTroveAccruedInterestReturns0When0AggRecordedDebt() public {
        ...
        transferfeUSD(A, B, feUSDToken.balanceOf(A));
    ...
    function testOpenTroveMintsInterestToSP() public {
        priceFeed.setPrice(2000e18);
        assertEq(feUSDToken.balanceOf(address(stabilityPool)), 0);
        ...
        uint256 boldBalSP_0 = feUSDToken.balanceOf(address(stabilityPool));
        ...
        uint256 boldBalSP_1 = feUSDToken.balanceOf(address(stabilityPool));
        ...
        uint256 boldBalSP_2 = feUSDToken.balanceOf(address(stabilityPool));
    ...
    function testCloseTroveReducesBorrowerBoldBalByEntireTroveDebtLessGasComp() public {
        ...
        // A sends Bold to B so B can cover their interest and close their Trove
        transferfeUSD(A, B, feUSDToken.balanceOf(A));
        uint256 bal_B = feUSDToken.balanceOf(B);
        ...
        assertEq(feUSDToken.balanceOf(B), bal_B - (entireDebt_B));
    }
    ...
    function testAdjustTroveInterestRateMintsAggInterestToSP() public {
        ...
        // Get SP balance
        uint256 spBal_1 = feUSDToken.balanceOf(address(stabilityPool));
        ...
        public
    {
        ...
        // A draws more debt
        withdrawfeUSD100pct(A, ATroveId, debtIncrease);
    ...
    function testWithdrawBoldMintsAggInterestAndUpfrontFeeToSP() public {
        ...
        uint256 balanceBefore = feUSDToken.balanceOf(address(stabilityPool));
        ...
        assertEq(feUSDToken.balanceOf(address(stabilityPool)) - balanceBefore, expectedSPYield);
    }
        ...
        public
    {
        ...
        repayfeUSD(A, ATroveId, debtDecrease);
        ...
        public
    {
        ...
        uint256 defaultPoolDebt = defaultPool.getfeUSDDebt();
        ...
        assertEq(defaultPool.getfeUSDDebt(), debtInLiq);
    }
