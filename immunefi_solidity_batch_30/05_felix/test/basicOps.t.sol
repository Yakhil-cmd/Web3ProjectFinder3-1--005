...
contract BasicOps is DevTestSetup {
    ...
    function testSPDeposit() public {
        ...
        assertGt(feUSDToken.balanceOf(A), 1800e18, "Wrong bold balance");
        assertLt(feUSDToken.balanceOf(A), 1801e18, "Wrong bold balance");
        assertApproximatelyEqual(stabilityPool.getCompoundedfeUSDDeposit(A), 200e18, 1e3, "Wrong SP deposit");
    }
    ...
    function testSPWithdrawal() public {
        ...
        assertEq(feUSDToken.balanceOf(A), 1900e18);
        assertApproximatelyEqual(stabilityPool.getCompoundedfeUSDDeposit(A), 100e18, 1e2);
        ...
        assertGt(feUSDToken.balanceOf(A), 1999e18, "Wrong bold balance");
        assertLt(feUSDToken.balanceOf(A), 2000e18, "Wrong bold balance");
        assertEq(stabilityPool.getCompoundedfeUSDDeposit(A), 1e18, "Wrong SP deposit");
    }
}
