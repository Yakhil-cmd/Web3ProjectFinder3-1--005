...
contract InterestRateBasic is DevTestSetup {
    ...
    function testWithdrawfeUSDSetsTroveLastDebtUpdateTimeToNow() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDWithdrawal = 500e18;
        ...
        // A draws more debt
        withdrawfeUSD100pct(A, ATroveId, feUSDWithdrawal);
        assertEq(troveManager.getTroveLastDebtUpdateTime(ATroveId), block.timestamp);
    }

    function testWithdrawfeUSDReducesTroveAccruedInterestTo0() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDWithdrawal = 500e18;
    ...
    function testWithdrawfeUSDIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDWithdrawal = 500e18;
        ...
        uint256 upfrontFee = predictAdjustTroveUpfrontFee(ATroveId, feUSDWithdrawal);
        ...
        assertEq(entireTroveDebt_2, entireTroveDebt_1 + feUSDWithdrawal + upfrontFee);
    }

    function testWithdrawfeUSDIncreasesRecordedTroveDebtByAccruedInterestPlusWithdrawnAmountPlusUpfrontFee() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 2000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDWithdrawal = 500e18;
        ...
        uint256 recordedTroveDebt_2 = troveManager.getTroveDebt(ATroveId);
        assertEq(recordedTroveDebt_2, recordedTroveDebt_1 + accruedTroveInterest + feUSDWithdrawal + upfrontFee);
    }

    // --- repayfeUSD ---

    function testRepayfeUSDSetsTroveLastDebtUpdateTimeToNow() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDRepayment = 500e18;
        ...
        // A repays feUSD
        repayfeUSD(A, ATroveId, feUSDRepayment);

        assertEq(troveManager.getTroveLastDebtUpdateTime(ATroveId), block.timestamp);
    }

    function testRepayfeUSDReducesTroveAccruedInterestTo0() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDRepayment = 500e18;
    ...
    function testRepayfeUSDReducesEntireTroveDebtByRepaidAmount() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDRepayment = 500e18;
        ...
        uint256 entireTroveDebt_2 = troveManager.getTroveEntireDebt(ATroveId);
        assertEq(entireTroveDebt_2, entireTroveDebt_1 - feUSDRepayment);
    }

    function testRepayfeUSDChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount() public {
        priceFeed.setPrice(2000e18);
        uint256 troveDebtRequest = 3000e18;
        uint256 interestRate = 25e16;
        uint256 feUSDRepayment = 500e18;
        ...
        assertEq(postRepay.recordedDebt, preRepay.recordedDebt + preRepay.accruedInterest - feUSDRepayment);
    }
    ...
    function testApplyTroveInterestPermissionlessUpdatesRedistribution() public {
        ...
        assertGt(troveData.redistfeUSDDebtGain, 0, "A should have redist gains");
    ...
    function testOpenTroveMintsUpfrontFeeToInterestReceivers() public {
        ...
        assertEqDecimal(
            feUSDToken.balanceOf(address(stabilityPool)) + feUSDToken.balanceOf(address(mockInterestRouter)),
            fee,
            18,
