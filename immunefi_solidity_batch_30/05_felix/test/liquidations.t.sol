...
contract LiquidationsTest is DevTestSetup {
    ...
    function testLiquidationOffsetWithSurplus() public {
        ...
        initialValues.spfeUSDBalance = stabilityPool.getTotalfeUSDDeposits();
        ...
        // Check SP feUSD has decreased
        uint256 finalSPfeUSDBalance = stabilityPool.getTotalfeUSDDeposits();
        assertEq(
            initialValues.spfeUSDBalance - finalSPfeUSDBalance,
            liquidationAmount + initialValues.AInterest,
            "SP feUSD balance mismatch"
        );
    ...
    function testLiquidationOffsetNoSurplus() public {
        ...
        uint256 initialSPfeUSDBalance = stabilityPool.getTotalfeUSDDeposits();
        ...
        // Check SP feUSD has decreased
        uint256 finalSPfeUSDBalance = stabilityPool.getTotalfeUSDDeposits();
        assertEq(initialSPfeUSDBalance - finalSPfeUSDBalance, liquidationAmount + AInterest, "SP feUSD balance mismatch");
    ...
    function testLiquidationRedistributionNoSurplus() public {
        ...
        // Check empty SP
        assertEq(stabilityPool.getTotalfeUSDDeposits(), 0, "SP should be empty");
    ...
    function testLiquidationMix() public {
        ...
        vars.spfeUSDBalance = stabilityPool.getTotalfeUSDDeposits();
        ...
        assertEq(vars.spfeUSDBalance - finalSPfeUSDBalance, vars.liquidationAmount / 2 - 1e18, "SP feUSD balance mismatch");
        // Check SP Coll has  increased
        uint256 finalSPCollBalance = stabilityPool.getCollBalance();
