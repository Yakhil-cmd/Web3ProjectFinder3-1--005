...
contract InterestBatchManagementTest is DevTestSetup {
    ...
    function testCannotSetBatchManagerIfTroveIsClosed() public {
        ...
        // Close trove
        deal(address(feUSDToken), A, 6000e18); // Needs more feUSD for interest and upfront fee
    ...
    function testCannotBorrowInsideABatchIfBelowMCRPlusBCR() public {
        ...
        vm.startPrank(A);
        vm.expectRevert(BorrowerOperations.ICRBelowMCRPlusBCR.selector);
        borrowerOperations.withdrawfeUSD(troveId, boldAmount, boldAmount);
        vm.stopPrank();
    }
    ...
    function testCannotAdjustInsideABatchIfBelowMCRPlusBCR1() public {
        ...
        uint256 repayfeUSD = debt - (coll - withdrawColl) * price / (MCR + BCR) - 1;
        //console2.log(coll - withdrawColl, "coll - withdrawColl");
        //console2.log(debt - repayfeUSD, "debt - repayfeUSD");

        vm.startPrank(A);
        vm.expectRevert(BorrowerOperations.ICRBelowMCRPlusBCR.selector);
        borrowerOperations.adjustTrove(troveId, withdrawColl, false, repayfeUSD, false, 10000e18);
        vm.stopPrank();
    }
    ...
    function testCannotAdjustInsideABatchIfBelowMCRPlusBCR2() public {
        ...
        uint256 borrowfeUSD = 195000e18;
        uint256 addColl = (debt + borrowfeUSD) * (MCR + BCR) / price - coll;
        //console2.log(debt+borrowfeUSD, "debt+borrowfeUSD");
        //console2.log(coll+addColl, "coll+addColl");

        vm.startPrank(A);
        vm.expectRevert(BorrowerOperations.ICRBelowMCRPlusBCR.selector);
        borrowerOperations.adjustTrove(troveId, addColl, true, borrowfeUSD, true, 10000e18);
        vm.stopPrank();
    }
