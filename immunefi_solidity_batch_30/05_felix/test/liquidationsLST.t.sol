...
contract LiquidationsLSTTest is DevTestSetup {
    function setUp() public override {
        ...
        (contracts, collateralRegistry, feUSDToken,,,,) = deployer.deployAndConnectContracts(
            TestDeployer.TroveManagerParams(160e16, 120e16, 120e16, 5e16, 10e16, 10_000_000 ether)
        );
    ...
    function testLiquidationFuzz(uint256 _finalPrice, uint256 _spAmount) public {
        ...
        makeSPDepositAndClaim(A, MIN_FEUSD_IN_SP);
        ...
        finalValues.spfeUSDBalance = stabilityPool.getTotalfeUSDDeposits();
        assertEq(initialValues.spfeUSDBalance - finalValues.spfeUSDBalance, _spAmount, "SP feUSD balance mismatch");
