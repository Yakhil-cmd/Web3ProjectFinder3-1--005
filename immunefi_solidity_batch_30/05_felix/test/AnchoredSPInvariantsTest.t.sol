...
contract AnchoredSPInvariantsTest is DevTestSetup {
    ...
    function invariant_allFundsClaimable() internal view {
        ...
        uint256 stabilityPoolBold = stabilityPool.getTotalfeUSDDeposits();
        ...
        for (uint256 i = 0; i < actors.length; ++i) {
            ...
            claimableBold += stabilityPool.getCompoundedfeUSDDeposit(actors[i].account);
        ...
        assertApproxEqAbsDecimal(stabilityPoolBold, claimableBold, 0.001 ether, 18, "SP feUSD !~ claimable feUSD");
