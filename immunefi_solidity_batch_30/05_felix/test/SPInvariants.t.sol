...
abstract contract SPInvariantsBase is Assertions, BaseInvariantTest {
    ...
    function setUp() public override {
        ...
        (TestDeployer.LiquityContractsDev memory contracts,, IfeUSDToken feUSDToken, HintHelpers hintHelpers,,,) =
    ...
    function assert_AllFundsClaimable() internal view {
        ...
        assertGeDecimal(stabilityPoolfeUSD, claimablefeUSD, 18, "SP BOLD insolvency");
        assertApproxEqAbsRelDecimal(stabilityPoolfeUSD, claimablefeUSD, 1e-7 ether, 1, 18, "SP BOLD loss");
