...
contract BorrowerOperationsTest is DevTestSetup {
    function testCloseLastTroveReverts() public {
        ...
        deal(address(feUSDToken), A, aliceDebt);
    ...
    function testRepayingTooMuchDebtCapsAtMinDebt() public {
        ...
        deal(address(feUSDToken), A, 3_000 ether);
        vm.prank(A);
        borrowerOperations.repayfeUSD(troveId, 3_000 ether);
    ...
    function testOpenTroveChargesUpfrontFee() public {
        ...
        uint256 activePoolDebtBefore = activePool.getfeUSDDebt();
        ...
        uint256 activePoolDebtAfter = activePool.getfeUSDDebt();
    ...
    function testWithdrawfeUSDChargesUpfrontFee() public {
        ...
        vm.prank(A);
        borrowerOperations.withdrawfeUSD(troveId, withdrawal, upfrontFee);
    ...
    function testWithdrawfeUSDRevertsIfUpfrontFeeExceedsUserProvidedLimit() public {
        uint256 troveId = openTroveNoHints100pct(A, 100 ether, 10_000 ether, 0.05 ether);
        ...
        vm.prank(A);
        vm.expectRevert(BorrowerOperations.UpfrontFeeTooHigh.selector);
        borrowerOperations.withdrawfeUSD(troveId, withdrawal, upfrontFee - 1);
    }
    ...
    function testAdjustInterestRateChargesUpfrontFeeWhenPremature() public {
        ...
        activePoolDebtBefore = activePool.getfeUSDDebt();
        ...
        activePoolDebtAfter = activePool.getfeUSDDebt();
