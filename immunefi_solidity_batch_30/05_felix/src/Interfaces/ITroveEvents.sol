...
interface ITroveEvents {
    ...
    event Liquidation(
        ...
        uint256 _feUSDGasCompensation,
        uint256 _collGasCompensation,
        uint256 _collSentToSP,
        uint256 _collRedistributed,
        uint256 _collSurplus,
        uint256 _L_ETH,
        uint256 _L_feUSDDebt,
        uint256 _price
    );

    event Redemption(
        uint256 _attemptedfeUSDAmount, uint256 _actualfeUSDAmount, uint256 _ETHSent, uint256 _ETHFee, uint256 _price
    );
