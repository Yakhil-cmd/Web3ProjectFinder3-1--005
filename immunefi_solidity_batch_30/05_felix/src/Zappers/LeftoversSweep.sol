...
contract LeftoversSweep {
    ...
    function _setInitialTokensAndBalances(
        ...
        _setInitialTokensBalancesAndReceiver(_collToken, _feUSDToken, _initialBalances, msg.sender);
    }

    function _setInitialTokensBalancesAndReceiver(IERC20 _collToken, IfeUSDToken _feUSDToken, InitialBalances memory _initialBalances, address _receiver)
        internal
        view
    {
        _initialBalances.tokens[0] = _collToken;
        _initialBalances.tokens[1] = IERC20(address(_feUSDToken));
