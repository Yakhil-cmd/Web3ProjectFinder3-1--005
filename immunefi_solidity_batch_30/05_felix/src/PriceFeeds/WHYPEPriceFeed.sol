...
import "../Interfaces/IWHYPEPriceFeed.sol";

contract WHYPEPriceFeed is MainnetPriceFeedBase, IWHYPEPriceFeed {
    ...
    function hypeUsdOracle() external view returns (AggregatorV3Interface, uint256, uint8) {
        return (ethUsdOracle.aggregator, ethUsdOracle.stalenessThreshold, ethUsdOracle.decimals);
    }
}
