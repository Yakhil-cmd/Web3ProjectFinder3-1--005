 ...
 */
contract AdminControllerNoDelays is AccessControlUpgradeable {
    ...
    /// @notice Throws if the merkle root is invalid in pushWeeklyRewards
    error AdminController__InvalidMerkleRoot();
    ...
    // - Change Max Debt Cap
    // - Add new collateral
    uint256 public constant STANDARD_OPERATIONS_DELAY = 0 days; 
    ...
    uint256 public constant SENSITIVE_OPERATIONS_DELAY = 0 days; 
    ...
    uint256 public constant MAX_DEBT_LIMIT = 1_000_000_000 ether;
