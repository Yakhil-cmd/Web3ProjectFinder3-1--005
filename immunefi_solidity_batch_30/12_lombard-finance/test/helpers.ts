...
export async function initStakedLBTC(owner: string, treasury: string, initialOwnerDelay: bigint = 0n) {
  const lbtc = await deployContract<StakedLBTC & Addressable>('StakedLBTC', [treasury, owner, initialOwnerDelay]);
