...
contract CreateStakedBTCNMerkleRoot is Script, MerkleTreeHelper {
    ...
    //one offs
    address camelotDecoderAndSanitizer =
        0x3FD48BE8d8fB633696AcB6dBE70166c81e869320;
    ...
    function generateAdminStrategistMerkleRoot() public {
        ...
        _addLeafsForCurveSwapping3Pool(
            leafs,
            getAddress(sourceChain, "curve_pool_LBTC_WBTCN_EBTC")
        );
        ...
        // ========================== Tellers ==========================
        {
            ...
            address[] memory tellerAssetAddrs = new address[](2);
            tellerAssetAddrs[0] = getAddress(sourceChain, "WBTCN");
            tellerAssetAddrs[1] = getAddress(sourceChain, "LBTC");

            // note, eth just means native asset placeholder addr 0xEee...
            ...
            ); //no native deposit, no bulk deposit/withdraw
        ...
        _addERC4626Leafs(
            leafs,
            ERC4626(getAddress(sourceChain, "smokehouseBTCN"))
        );

        // ========================== Morpho Blue ==========================
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "WBTCN_IDLE_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "WBTCN_LBTC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "USDT0_IDLE_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "WBTCN_USDT0_915")
        );
