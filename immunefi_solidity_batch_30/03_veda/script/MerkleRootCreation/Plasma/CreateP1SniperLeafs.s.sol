...
/**
 *  source .env && forge script script/MerkleRootCreation/Plasma/CreateP1SniperLeafs.s.sol --rpc-url $PLASMA_RPC_URL --gas-limit 1000000000000000000
 */
contract CreateP1SniperLeafMerkleRoot is Script, MerkleTreeHelper {
    ...
    function generateStrategistMerkleRoot() public {
        ...
        // ========================== Aave V3 ==========================
        ERC20[] memory withdrawAssets = new ERC20[](1);
        withdrawAssets[0] = getERC20(sourceChain, "USDT0");
        _addAaveV3WithdrawLeafs(leafs, withdrawAssets, "AaveV3");
        ...
        string memory filePath = "./leafs/Plasma/P1USDSniperLeafs.json";
