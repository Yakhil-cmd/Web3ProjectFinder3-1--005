...
/**
 *  source .env && forge script script/MerkleRootCreation/Plasma/CreatePlasmaUSDSniperLeafs.s.sol --rpc-url $PLASMA_RPC_URL --gas-limit 1000000000000000000
 */
contract CreatePlasmaUSDMerkleRoot is Script, MerkleTreeHelper {
    ...
    function generateStrategistMerkleRoot() public {
        ...
        string memory filePath = "./leafs/Plasma/PlasmaUSDSniperLeafs.json";
